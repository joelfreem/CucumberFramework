...
public class HardCodedExamples {
    ...
    String token = "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE2NTUzMzQ5MTcsImlzcyI6ImxvY2FsaG9zdCIsImV4cCI6MTY1NTM3ODExNywidXNlcklkIjoiMzc4MSJ9.dP6IVIj0Gmt3rJwpYGuJuyqwQVKHwMqBx-v32R_rxC0";
    ...
    public void acreateEmployee(){
        ...
        response.then().assertThat().body("Employee.emp_firstname",equalTo("Something"));
    ...
    public void bgetCreatedEmployee(){
        RequestSpecification preparedrequest= given().header("Content-Type","aplication/json").
    ...
    public void cupdateEmployee(){
        RequestSpecification preparedRequest= given().header("Content-Type","application/json").
                header("Authorization",token).body("{\n" +
                        ...
                        "  \"emp_firstname\": \"Mark\",\n" +
                        "  \"emp_lastname\": \"Walburg\",\n" +
                        "  \"emp_middle_name\": \"MS\",\n" +
                        "  \"emp_gender\": \"M\",\n" +
                        "  \"emp_birthday\": \"1996-06-12\",\n" +
