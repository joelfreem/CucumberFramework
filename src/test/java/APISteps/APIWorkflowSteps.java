...
public class APIWorkflowSteps {
    ...
    @Then("the employee id {string} is stored as a global variable to be used ofr other calls")
    public void the_employee_id_is_stored_as_a_global_variable_to_be_used_ofr_other_calls(String empId) {
    ...
    @Then("the retrieve data at {string} object matches the data used to create the employee having employee id {string}")
    public void the_retrieve_data_at_object_matches_the_data_used_to_create_the_employee_having_employee_id(String empObject, String resEmpID, DataTable dataTable) {
        ...
        for (Map<String,String>singlePairOfData:expectedData
            ...
            //it will return the set of keys form the map
